...
export interface SubzillaAPI {
    ...
    processFile: (filePath: string, options?: IConvertOptions) => Promise<{ success: boolean; outputPath?: string; backupPath?: string; error?: string }>;
    processFilesBatch: (filePaths: string[], options?: IConvertOptions) => Promise<{ success: boolean; stats?: IBatchStats; error?: string }>;
...
const api: SubzillaAPI = {
    ...
    processFile: (filePath: string, options?: IConvertOptions) => 
